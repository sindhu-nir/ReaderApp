package com.elahee.readerapp.screens.stats
            ...
            Column {
                ...
                Card(modifier = Modifier
                    ...
                    Column(modifier = Modifier.padding(start = 25.dp, top = 4.dp, bottom = 4.dp),
                        ...
                        androidx.compose.material.Text(text = "Your Stats", style = MaterialTheme.typography.h5)
                        Divider()
                        androidx.compose.material.Text(text = "You're reading: ${readingBooks.size} books")
                        androidx.compose.material.Text(text = "You've read: ${readBooksList.size} books")
    ...
    Card(modifier = Modifier
        ...
        Row(modifier = Modifier.padding(5.dp),
            ...
            Column {
                ...
                androidx.compose.material.Text(text =  "Author: ${book.authors}",
                    overflow = TextOverflow.Clip,
                    fontStyle = FontStyle.Italic,
                    style = MaterialTheme.typography.caption)

                androidx.compose.material.Text(text =  "Started: ${formatDate(book.startedReading!!)}",
                    softWrap = true,
                    overflow = TextOverflow.Clip,
                    fontStyle = FontStyle.Italic,
                    style = MaterialTheme.typography.caption)

                androidx.compose.material.Text(text =  "Finished ${formatDate(book.finishedReading!!)}",
                    overflow = TextOverflow.Clip,
                    fontStyle = FontStyle.Italic,
                    style = MaterialTheme.typography.caption)
