...
import com.elahee.readerapp.components.EmailInput
import com.elahee.readerapp.components.PasswordInput
...
fun LoginScreen(navController: NavController,
    ...
    Surface(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ReaderLogo()
            if (showLoginForm.value) ReaderForm(loading = false, isCreateAccount = false) { email, password ->
                viewModel.signWithEmailAndPassword(email=email, password=password){
                    navController.navigate(ReaderScreens.ReaderHomeScreen.name)
                }
            }
            else {
                ReaderForm(loading = false, isCreateAccount = true){email, password ->
